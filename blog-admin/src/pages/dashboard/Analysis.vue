...
const data = ref([
  {
    name: "Github",
    icon: markRaw(IAntDesignGithubFilled),
    message: "workplace.introduction",
    personal: "Archer",
    time: "2022-10-19T10:37:05.498Z",
  },
  {
    name: "Vue",
    icon: markRaw(ILogosVue),
    message: "workplace.introduction",
    personal: "Archer",
    time: "2022-10-19T10:37:05.498Z",
  },
  {
    name: "Angular",
    icon: markRaw(ILogosAngularIcon),
    message: "workplace.introduction",
    personal: "Archer",
    time: "2022-10-19T10:37:05.498Z",
  },
...
const updataData = ref([
  ...
  },
  {
    time: "2022-10-06",
    name: "yulinZ",
    list: ["1. 更新文件统一类型", "2. 更新项目 logo", "3. 去除多余代码"],
  },
]);
  ...
  <ElRow :gutter="20" justify="space-between">
    ...
    <ElCol :xl="14" :lg="14" :md="24" :sm="24" :xs="24">
      <ElCard shadow="hover" class="mb-20px">
        <ElSkeleton :loading="loading" animated>
          <h2>更新日志</h2>
          <el-card shadow="hover" v-for="item in updataData">
            <div style="display: flex; justify-content: space-between">
              <div>{{ item.time }}</div>
              <div>{{ item.name }}</div>
            </div>
            <ul>
              <li v-for="Litem in item.list">{{ Litem }}</li>
            </ul>
          </el-card>
        </ElSkeleton>
      </ElCard>

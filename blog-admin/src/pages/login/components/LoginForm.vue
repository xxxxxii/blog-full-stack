 ...
 * @LastEditTime: 2022-12-08 19:49:48
...
<template>
  <el-form
    ...
    :model="loginUser"
    :rules="rules"
    class="w-full loginForm sign-in-form"
  >
    ...
    <el-form-item prop="code">
      <el-row>
        ...
        <el-col :span="12">
          <div class="ml-2 mr-2">
            <img class="cursor-pointer" :src="codeUrl" @click="resetCode" />
          </div>
        </el-col>
      </el-row>
    </el-form-item>
...
const codeUrl = ref(import.meta.env.VITE_API_URL + "/user/code");
const resetCode = () => {
  codeUrl.value += "?" + new Date().getTime();
};
...
function toLogin() {
  userStore.login(props.loginUser).then((res: any) => {

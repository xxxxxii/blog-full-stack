...
const o = { __name: "nuxt-error-page", __ssrInlineRender: true, props: { error: Object }, setup(s2) {
  ...
  const u2 = Number(a2.statusCode || 500), d = 404 === u2, l = null != (o2 = a2.statusMessage) ? o2 : d ? "Page Not Found" : "Internal Server Error", p = a2.message || a2.toString(), i = defineAsyncComponent(() => import('./error-404.e00dfe42.mjs').then((e2) => e2.default || e2)), c = defineAsyncComponent(() => import('./error-500.73a0274d.mjs').then((e2) => e2.default || e2)), m = d ? i : c;
  return (e2, s3, o3, a3) => {
...
export { u as default };
//# sourceMappingURL=error-component.6b7b3ce1.mjs.map
